function h = drawVehicle(posX,posY,heading,t,scaleBody)

uu = zeros(13,1);

    % process inputs to function
    pn       = posY;%uu(1);       % inertial North position     
    pe       = posX;%uu(2);       % inertial East position
    ...
    if t<=3,%0.1,
        %figure(1)%, clf
        [Vertices,Faces,facecolors]  = defineVehicleBody(scaleBody) ;
...
% defineVehicleBody
%=======================================================================
function [V,F,facecolors] = defineVehicleBody(scaleBody)
%scaleBody = 5;
